...
export default function Home() {
    ...
    return (
        <div className="bg-black/70 relative w-screen h-screen overflow-hidden home-header-wrapper">
            <CanvasLines />
            <Header />
            <div className="relative h-screen w-screen flex items-center justify-center overflow-hidden">
                <div className="flex flex-col items-center text-center px-4 w-[90%] md:w-2xl gap-y-0.5">
                    <div className="text-4xl font-bold leading-tight px-4 py-1 rounded-md bg-black">
                        <p>
                    ...
                    <p className="text-blue-300 font-semibold px-4 py-2 rounded-md bg-black">
